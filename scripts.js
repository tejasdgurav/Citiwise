...
sortedUlbData.forEach(item => {
  ...
  // Input formatting and validation
    ...
    { id: 'reservation_area_sqm', validate: (value) => { const isVisible = document.getElementById('reservation_area_sqm').style.display !== 'none'; return isVisible ? (value.trim() !== '' && !isNaN(value) && parseFloat(value) >= 0 && parseFloat(value) <= 999999.99) : true; }, format: (input) => restrictToNumbers(input, true), errorMsg: 'Please enter a valid number between 0 and 999,999.99' },
